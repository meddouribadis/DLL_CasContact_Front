        ...
        <div className="container-xl">
            <div className="gutter-condensed gutter-lg flex-column flex-md-row d-flex">
                ...
                <div className="col col-12 col-md-3 mb-4 mb-md-0">
                    <div className="">
                        <a className="tooltipped tooltipped-s d-block mb-4" aria-label="Change your avatar"
                        ...
                        <div className="edit">
                            <button
                                className={"btn btn-primary btn-block mb-3 js-profile-editable-edit-button"}>Modifier
                                l'avatar
                            </button>
                        </div>
                        <div className="details">
                            ...
                            <p itemProp="email" aria-label="Email: meddouri.badis@gmail.com"
                               className="vcard-detail pt-1 css-truncate css-truncate-target ">
                                ...
                                <a className="u-email link-gray-dark mx-1"
                    ...
                    <form name="form" onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <input type="text" name="firstName" value={userForm.firstName} onChange={handleChange}
                                   className={'form-control' + (submitted && !userForm.firstName ? ' is-invalid' : '')}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="lastName" value={userForm.lastName} onChange={handleChange}
                                   className={'form-control' + (submitted && !userForm.lastName ? ' is-invalid' : '')}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="username" value={userForm.username} onChange={handleChange}
                                   className={'form-control' + (submitted && !userForm.username ? ' is-invalid' : '')}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="email" value={userForm.email} onChange={handleChange}
                                   className={'form-control' + (submitted && (!userForm.email || !mailValidate) ? ' is-invalid' : '')}
                                   aria-describedby="emailHelp" placeholder="Votre email"/>
                            <small id="emailHelp" className="form-text text-muted">Nous ne partagerons jamais votre mail
                                avec des tiers.</small>
                        ...
                        <div className="form-group">
                            ...
                            <select className={'form-control' + (submitted && !user.id_classe ? ' is-invalid' : '')}
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="numEtud" value={user.numEtud} onChange={handleChange}
                                   className={'form-control' + (submitted && !userForm.numEtud ? ' is-invalid' : '')}
